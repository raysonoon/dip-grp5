        ...
        {filteredStalls.map((stall) => (
          ...
          >
            ...
            <div style={{ padding: "16px", textAlign: "center" }}>
              ...
              <Link to={`/stall/${stall.id}`} style={{ display: "inline-block", color: "#fff", background: "var(--accent)", padding: "10px 16px", borderRadius: "var(--radius-lg)", textDecoration: "none", fontSize: "0.9rem", fontWeight: 600 }}>
                View Menu & Reviews
              </Link>
            </div>
          </div>
